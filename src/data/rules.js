...
const rules = {
  ...
  "gamepro.de": { j: 5 },
  "autobahn.de": {
    s: "#cookieman-modal,#cookieman-open-settings,.modal-backdrop,.cookie-overview,dialog[open],dialog.open{display:none!important;visibility:hidden!important}body.modal-open{overflow:auto!important}",
  },
