...
const rules = {
  ...
  "chatgpt.com": {
    s: 'div:is([class*="z-10 w-[100vw] max-w-[100vw] overflow-hidden"],[class*="bg-token-main-surface-tertiary"],[class*="flex w-full flex-row justify-end gap-3"]) { display: none !important; }',
  },
