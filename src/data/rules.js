...
const rules = {
  ...
  "gamepro.de": { j: 5 },
  "daileisure.co.uk": {
    s: '.notification-wrapper.notification-wrapper-bottom,.module-notification.notification[data-options*="cookie"],.notification-content,.notification-text{display:none!important}',
  },
