...
const rules = {
  ...
  "factcool.com": { s: "#__next > div > div + div > div > :nth-child(3),.fScrmm{display:none !important}" },
  "nightcafe.studio": { j: "3" },
  "dilynakotle.cz": { s: ".focus-cookiebara{display:none !important} .focus-opened{overflow:unset !important}" },
  "hoptimist.com": { c: 14 },
  "zill.de": {
