...
const rules = {
  ...
  "eau.veolia.fr": {
    s: ".ant-modal-root,.ant-modal-root .ant-modal-mask,.ant-modal-root .ant-modal-wrap,.ant-modal.app-modal{display:none!important}html,body,#root,.scrollable-container{overflow:auto!important}",
  },
