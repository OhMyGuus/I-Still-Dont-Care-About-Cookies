...
const rules = {
  ...
  "gamepro.de": { j: 5 },
  "shop.bondix.de": {
    s: 'section[id^="shopify-pc__banner"],#shopify-pc__banner__styles,#Compliance-cs-banner,.Compliance-cs-container,.Compliance-banner-content{display:none!important}',
  },
