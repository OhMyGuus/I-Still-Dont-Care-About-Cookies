...
const rules = {
  ...
  "365direkte.no": { s: ".cookie-consent-banner-modal{display:none!important}", c: 85 },
  "acierto.com": { s: ".vwo-overlay{display:none!important}", c: 85 },
  "advantageaustria.org": { s: "#cookies{display: none !important}", c: 85 },
  "amd.by": { c: 85 },
  "americanexpress.ch": { s: ".a-backdrop.state-a-backdrop--visible{display: none !important; visibility: hidden}", c: 85 },
  "andersiahotel.pl": { c: 85 },
  "toyota.astra.co.id": { s: "#cookieSection{display:none!important}"},
  "auo.com": { s: ".gdpr-mask{display:none!important} .gdpr{display: none !important}", c: 85 },
  ...
  "bingen-ruedesheimer.de": { s: ".pcblocker{display:none!important} .pc_privacy-badge{display: none !important}", c: 85 },
  "bunq.com": { s: ".fs-cc-components{display:none!important}"},
  "centrotiziano.it": { c: 85},
  "cinch.co.uk": { s: ".cookie-consent_overlay__QytSD{display:none!important}", c: 85 },
  "crossnative.com": { s: ".cookie-consent_overlay__X8p9d{display:none!important}"},
  "delano.de": { s: "#gatewayWindowShadestacks_in_3313_5{display:none!important}"},
  "digineb.eu": { c: 85 },
  "etelecinema.hu": { s: ".etele-mainlayout-cookieconsent{display:none!important}", c: 85 },
  ...
  "foma.cz": { s: ".mfp-wrap{display:none!important} .mfp-bg{display: none !important}", c: 85 },
  "garten-sauer.de": { c: 85 },
  "gastrokuchyn.cz": { s: ".electro-overlay{display:none!important}", c: 85 },
  "grandcentralhotelbelfast.com": { s: "#ACClayerBackground{display:none!important}", c: 85 },
};
