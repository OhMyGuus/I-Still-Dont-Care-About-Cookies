...
function getSelector(host) {
  ...
  switch (host.full) {
    ...
    case "instagram.com":
      return "//div[@role='dialog' and .//a[contains(@href, 'privacycenter.instagram.com/policies/cookies')]]//div//div//div//button[2]";
    ...
    case "awwwards.com":
      return 'strong.link-underlined[data-action="click->cookie-manager#rejectAll"]';
    ...
    case "ryobitools.eu":
      return _chain(".cookie-onetrust-show-info", ".save-preference-btn-handler");
